...
@Database(
    entities = [AllCardsDesigns::class, LocalCardDetailsModel::class, CategoryModel::class, CategoryModelSticker::class, TempModel::class],
    version = 1
)
@TypeConverters(ViewsConverter::class, BackgroundConverter::class, BitmapConverter::class)
abstract class AppDataBase : RoomDatabase() {
    abstract fun cardsDao(): CardsDao
    abstract fun backgroundDao(): BackgroundDao
    abstract fun stickerDao(): StickerDao

    abstract fun tempStickerDao(): TempStickerDao
}